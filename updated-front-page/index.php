...
<body class="text-slate-900">
    ...
    <nav class="flex items-center justify-between px-8 md:px-24 py-8 bg-white/80 backdrop-blur-md sticky top-0 w-full z-50 border-b border-gray-100">
        ...
        <div class="hidden md:flex space-x-8 text-sm font-bold text-gray-500 uppercase tracking-widest">
            ...
            <a href="/works.php" class="hover:text-black transition">Works</a>
            <a href="/skills.php" class="hover:text-black transition">Skills</a>
            <a href="/certificates.php" class="hover:text-black transition">Certificates</a>
            <a href="/contact.php" class="hover:text-black transition">Contact</a>
        </div>
    ...
    <div class="container mx-auto px-8 md:px-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
            ...
            <div class="col-span-1 md:col-span-1">
                <h3 class="text-2xl font-extrabold text-[#111827] mb-6">J4YEMZ</h3>
        ...
        <div class="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                © <?php echo date("Y"); ?> J4YEMZ — THE DIGITAL CURATOR.
            </p>
            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
